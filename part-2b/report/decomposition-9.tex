...
\subsection{Architectural design}
    ...
    \paragraph{UC21: Send invoice}
        ...
        1. The system constructs an invoice containing:
            { the provided service or product (e.g. monthly subscription fee for applications or purchased
            hardware),
        ...
        2. The system sends the invoice to the third-party invoicing service.
           InvoiceManager -> InvoicingService: interface Invoices
                                boolean sendInvoice(Map<string,string>)
