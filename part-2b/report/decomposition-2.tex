...
\subsection{Instantiation and allocation of functionality}
    ...
    \begin{itemize}
        ...
        \item PluggableDeviceFacade: UC11
    \end{itemize}
    ...
    \paragraph{Decomposition}
        ...
        \begin{figure}[!h]
        	\centering
            \includegraphics[width=1\textwidth]{images/component-diagram-22}
    ...
    \paragraph{Deployment}
        ...
        \begin{figure}[!h]
        	\centering
        	\includegraphics[width=0.8\textwidth]{images/deployment-diagram-22}
