%%% element catalog, generated on Mon May 01 16:18:35 CEST 2017
...
\subsection{AccessRightsManager}\label{comp:OnlineServiceAccessRightsManager}
	...
	\end{description}
\subsection{ActuationCommandConstructor}\label{comp:OnlineServiceApplicationManagerActuationCommandConstructor}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~{\colorbox{red!30}{\underline{Undefined}}}
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationManager}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceApplicationManagerActuation}}
...
\subsection{CustomerOrganisationFacade}\label{comp:OnlineServiceCustomerOrganisationFacade}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceCustomerOrganisationFacadeSubscriptionMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceApplicationManagerApps}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceUserRolesManagerRoleMgmt}}, \iconrequired{}~\vpett{\nameref{int:PuggableDevicePluggableDeviceFacadeSubscriptionManagerSubscriptionMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceTopologyManagerTopologyMgmt}}		
	\end{description}
\subsection{DeviceDataConverter}\label{comp:OnlineServiceDeviceDataConverter}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~The \vpett{\nameref{comp:OnlineServiceDeviceDataConverter}} is resposible for converting pluggable device data in the data processing subsystem.
		\item[Super-components:]~None
		\item[Sub-components:]~None
...
\subsection{InvoiceManager}\label{comp:OnlineServiceInvoiceManager}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OtherDataDBOtherDataDBInvoiceMgmt}}		
	\end{description}
...
\subsection{NotificationHandler}\label{comp:OnlineServiceNotificationHandler}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:NotificationDeliveryServiceNodeNotificationDeliveryServiceNotificationDeliveryMgmt}}, \iconrequired{}~\vpett{\nameref{int:OtherDataDBOtherDataDBNotificationMgmt}}		
	\end{description}
\subsection{OtherDataDB}\label{comp:OtherDataDBOtherDataDB}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~General database for data. For example, storage of data about notifications.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBAppMgmt}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBInvoiceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBIOMgmt}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBNotificationMgmt}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBOther}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBSubscriptionMgmt}}, \iconprovided{}~\vpett{\nameref{int:OtherDataDBOtherDataDBUserRoleMgmt}}
		\item[Required interfaces:]~None		
	\end{description}
...
\subsection{PluggableDeviceFacade}\label{comp:PuggableDevicePluggableDeviceFacade}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~\iconcomponent{}~\vpett{\nameref{comp:PuggableDevicePluggableDeviceFacadeSubscriptionManager}}
	...
	\end{description}
\subsection{SubscriptionManager}\label{comp:PuggableDevicePluggableDeviceFacadeSubscriptionManager}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~{\colorbox{red!30}{\underline{Undefined}}}
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:PuggableDevicePluggableDeviceFacade}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:PuggableDevicePluggableDeviceFacadeSubscriptionManagerSubscriptionMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceApplicationManagerApps}}, \iconrequired{}~\vpett{\nameref{int:OtherDataDBOtherDataDBSubscriptionMgmt}}		
	\end{description}
...
% no operations
  ...
  %%%%%%%% Actuation
  \subsection{Actuation}\label{int:OnlineServiceApplicationManagerActuation}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationManagerActuationCommandConstructor}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationManager}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationFacade}}
      \item[Operations:] ~
% no operations
    \end{description}

  %%%%%%%% AppData
  \subsection{AppData}\label{int:OnlineServiceApplicationFacadeAppData}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationFacade}}
...
TODO: update this with Relationship type?
  ...
  %%%%%%%% AppMgmt
  \subsection{AppMgmt}\label{int:OtherDataDBOtherDataDBAppMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationManager}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC18, Av3: automatic suspension/reactivation of applications.
  ...
  %%%%%%%% AppMgmt
  \subsection{AppMgmt}\label{int:OnlineServiceApplicationContainerManagerAppMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationContainerManager}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationManager}}
      \item[Operations:] ~
% no operations
    \end{description}
...
% no operations
  ...
  %%%%%%%% DeviceMgmt
  \subsection{DeviceMgmt}\label{int:OnlineServiceApplicationFacadeDeviceMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationFacade}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:ApplicationClient}}
      \item[Operations:] ~
...
\item Created for: Given constraint, UC14, Av3: failure detection
  ...
  %%%%%%%% InvoiceMgmt
  \subsection{InvoiceMgmt}\label{int:OtherDataDBOtherDataDBInvoiceMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
...
% no operations
  ...
  %%%%%%%% IOMgmt
  \subsection{IOMgmt}\label{int:OtherDataDBOtherDataDBIOMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceInfrastructureOwnerManager}}
      \item[Operations:] ~
...
\item Created for: UC15
  ...
  %%%%%%%% NotificationMgmt
  \subsection{NotificationMgmt}\label{int:OtherDataDBOtherDataDBNotificationMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceNotificationHandler}}
      \item[Operations:] ~
...
% no operations
  ...
  %%%%%%%% Other
  \subsection{Other}\label{int:OtherDataDBOtherDataDBOther}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOtherFunctionality1}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOtherFunctionality2}}
      \item[Operations:] ~
...
% no operations
  ...
  %%%%%%%% SubscriptionMgmt
  \subsection{SubscriptionMgmt}\label{int:OtherDataDBOtherDataDBSubscriptionMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:PuggableDevicePluggableDeviceFacadeSubscriptionManager}}
      \item[Operations:] ~
...
% no operations
  ...
  %%%%%%%% TopologyOverview
  \subsection{TopologyOverview}\label{int:OnlineServiceApplicationFacadeTopologyOverview}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceApplicationFacade}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:ApplicationClient}}
      \item[Operations:] ~
% no operations
  ...
  %%%%%%%% UserRoleMgmt
  \subsection{UserRoleMgmt}\label{int:OtherDataDBOtherDataDBUserRoleMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDBOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceUserRolesManager}}
      \item[Operations:] ~
