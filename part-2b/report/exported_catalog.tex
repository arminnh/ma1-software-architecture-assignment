%%% element catalog, generated on Tue May 09 01:14:11 CEST 2017
...
\subsection{AuthenticationManager}\label{comp:OnlineServiceOnlineServiceAuthenticationManager}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:SessionDBAuthentication}}		
	\end{description}
...
\item Created for: Av2 - The system is able to autonomously detect failing applications
  ...
  %%%%%%%% Authentication
  \subsection{Authentication}\label{int:SessionDBAuthentication}
    \begin{description}[noitemsep,nolistsep]
...
% no operations
  ...
  %%%%%%%% Authentication
  \subsection{Authentication}\label{int:OnlineServiceOnlineServiceRegisteredUserFacadeAuthentication}
    \begin{description}[noitemsep,nolistsep]
