%%% element catalog, generated on Wed May 10 09:19:07 CEST 2017
...
\subsection{ApplicationContainer}\label{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~This component contains a sandbox environment for an application instance to execute in. The container itself can detect when applications crash. In that case, the container notifies the \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerMonitor}}.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}
		\item[Sub-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerContainerLogic}}
...
\subsection{ApplicationExecutionSubsystemMonitor}\label{comp:OnlineServiceOnlineServiceApplicationManagerApplicationExecutionSubsystemMonitor}
	...
	\end{description}
\subsection{ApplicationFrontEndClient}\label{comp:ApplicationFrontEndClient}
	\begin{description}[noitemsep,nolistsep]
...
\subsection{ApplicationFrontEndFacade}\label{comp:OnlineServiceOnlineServiceApplicationFrontEndFacade}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicDeviceCommands}}
	\end{description}
\subsection{ApplicationInstance}\label{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Represents an application instance running in the system.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}} $\triangleright$ \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMonitoring}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerDeviceDataConverterDataConversion}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicDeviceCommands}}
	\end{description}
...
\subsection{ApplicationManager}\label{comp:OnlineServiceOnlineServiceApplicationManager}
	...
	\end{description}
\subsection{ApplicationProviderClient}\label{comp:ApplicationProviderClient}
	\begin{description}[noitemsep,nolistsep]
	...
	\end{description}
\subsection{ApplicationProviderFacade}\label{comp:OnlineServiceOnlineServiceApplicationProviderFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for application provider's client and handles all functionality that can be done by application providers.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationProviderFacadeApplications}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicFrontEndAppRequests}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
	\end{description}
\subsection{AuthenticationManager}\label{comp:OnlineServiceOnlineServiceAuthenticationManager}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Handles all functionality related to authentication of users.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OtherDataDatabaseOtherDataDBAuthentication}}, \iconrequired{}~\vpett{\nameref{int:SessionDBSessions}}
	\end{description}
\subsection{ContainerLogic}\label{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerContainerLogic}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~The logic of an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}. Handles communication from/to ApplicationInstances and can maintain/monitor them.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}} $\triangleright$ \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerDeviceDataConverterDataConversion}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicDeviceCommands}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMonitoring}}
	\end{description}
...
\subsection{CustomerOrganisationFacade}\label{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceCustomerOrganisationFacadeSubscriptionMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceCustomerOrganisationFacadeUserMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicFrontEndAppRequests}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUserManagerRoleMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceSubscriptionManagerSubscriptionMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUserManagerUserMgmt}}
	\end{description}
...
\subsection{Gateway}\label{comp:GatewayGateway}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayDeviceManager}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationMonitor}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerHeartbeat}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:MoteMoteActuate}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:MoteMoteConfig}}, \iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconrequired{}~\vpett{\nameref{int:MoteMoteRequestData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
\subsection{GatewayCommunicationHandler}\label{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Isolates communication-related concerns between the Online Service Gateways and along with OnlineServiceBroker on Gateways. Forwards requests from one party to the other and transmits results and possible exceptions. \\
Sends acknowledgements for all messages sent by Gateways so that they can detect failures.
		\item[Super-components:]~None
		\item[Sub-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitor}}
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
\subsection{GatewayCommunicationMonitor}\label{comp:OnlineServiceOnlineServiceGatewayCommunicationMonitor}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Sub-components:]~None
		\item[Provided interfaces:]~None
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationMonitoring}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}
	\end{description}
\subsection{GatewayMonitor}\label{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitor}
	\begin{description}[noitemsep,nolistsep]
...
5000 gateways * (32 bit gatewayID + 4 bit countSynchronisationsMissed + 64 bit lastSyncPeriod + 64 bit nextSyncPeriod) == approx 100kb => Seems ok
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitorGatewayUpdates}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationMonitoring}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}
	\end{description}
\subsection{GWCommunicationLogic}\label{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Handles all actual functionality related to communication. When Gateways synchronise with the Online Service, this component notifies the \vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitor}} so that it can keep track of \vpett{\nameref{comp:GatewayGateway}}'s status.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitorGatewayUpdates}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
...
\subsection{InfrastructureOwnerFacade}\label{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceInfrastructureOwnerFacadeAccessRights}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceInfrastructureOwnerFacadeTopologyMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAccessRightsManagerAccessRightsMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicFrontEndAppRequests}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceInfrastructureOwnerManagerIOMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
...
E.g. creating invoices.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceInvoiceManagerDeliveryMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceInvoiceManagerInvoiceMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OtherDataDatabaseOtherDataDBDBInvoiceMgmt}}, \iconrequired{}~\vpett{\nameref{int:ThirdPartyInvoicingServiceInvoiceDeliveryMgmt}}
	\end{description}
...
\subsection{NotificationHandler}\label{comp:OnlineServiceOnlineServiceNotificationHandler}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerDeliveryMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifications}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OtherDataDatabaseOtherDataDBDBNotificationMgmt}}, \iconrequired{}~\vpett{\nameref{int:ThirdPartyNotificationDeliveryServiceNodeThirdPartyNotificationDeliveryServiceNotificationDeliveryMgmt}}
	\end{description}
\subsection{OnlineServiceCommunicationHandler}\label{comp:GatewayGatewayOnlineServiceCommunicationHandler}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Isolates communication-related concerns between Gateways and the Online Service along with GatewayBroker on the Online Service. Forwards requests from one party to the other and transmits results and possible exceptions. \\
...
Can store at least 3 days of pluggable data and application commands before old data has to be overwritten.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}
		\item[Sub-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
\subsection{OnlineServiceCommunicationMonitor}\label{comp:GatewayGatewayOnlineServiceCommunicationMonitor}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Sub-components:]~None
		\item[Provided interfaces:]~None
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}}
	\end{description}
\subsection{OnlineServiceMonitor}\label{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Monitors the \vpett{\nameref{comp:GatewayGateway}}'s connectivity to the Online Service. \\
If the Online Service or the communication channel has failed, all requests to the Online Service will be stopped and stay stored in the \vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}. An explicit command for this is not necessary, because the requests in the \vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}} will not be deleted, since no acknowledgements are received anymore from the Online Service.\\
...
When the Online Service is unreachable, application parts running locally on the SIoTIP gateway continue to operate normally.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}} $\triangleright$ \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitorOSUpdates}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogicOSMonitoring}}
	\end{description}
\subsection{OSCommunicationLogic}\label{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Handles all actual functionality related to communication. When a message comes in from the Online Service, lets the \vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}} know that a message has been received. When an acknowledgements for requests are received from the Online Service, notifies the \vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}} of this so that it can delete the request from its storage.
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}} $\triangleright$ \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogicOSMonitoring}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerAppDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:DeviceDatabaseDeviceDBDBDeviceMgmt}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayDeviceManagerDeviceCommands}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicGWAppInstanceMgmt}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitorOSUpdates}}, \iconrequired{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerRequestStoreRequests}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceTopologyManagerTopologyMgmt}}
	\end{description}
...
\subsection{RegisteredUserFacade}\label{comp:OnlineServiceOnlineServiceRegisteredUserFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for common functionality between different types of users and handles all functionality that is shared between them.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceNotificationHandlerNotifications}}
	\end{description}
\subsection{RequestStore}\label{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~\iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}} $\triangleright$ \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}}, \iconprovided{}~\vpett{\nameref{int:GatewayGatewayOnlineServiceCommunicationHandlerRequestStoreRequests}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceDeviceDataSchedulerDeviceData}}
	\end{description}
\subsection{SessionDB}\label{comp:SessionDB}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~This database stores sessions.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:SessionDBSessions}}
		\item[Required interfaces:]~None
...
\subsection{SystemAdministratorFacade}\label{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for SystemAdministratorClient and handles all functionality that can be done by application providers.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
...
\subsection{ThirdPartyInvoicingService}\label{comp:ThirdPartyInvoicingService}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Represents a third party invoicing service.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~None
		\item[Required interfaces:]~None
...
\subsection{UnregisteredUserClient}\label{comp:UnregisteredUserClient}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Represents the client used by an unregistered user.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~None
		\item[Required interfaces:]~None
...
\subsection{UnregisteredUserFacade}\label{comp:OnlineServiceOnlineServiceUnregisteredUserFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for unregistered users client and handles all functionality that can be done by unregistered users.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUnregisteredUserFacadeRegistration}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUserManagerUserMgmt}}
	\end{description}
\subsection{UserManager}\label{comp:OnlineServiceOnlineServiceUserManager}
	\begin{description}[noitemsep,nolistsep]
		...
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUserManagerRoleMgmt}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceUserManagerUserMgmt}}
		\item[Required interfaces:]~\iconrequired{}~\vpett{\nameref{int:OtherDataDatabaseOtherDataDBDBUserMgmt}}
	\end{description}
...
\item Created for: UC9.1
        \end{itemize}
      \item \textsf{void updateAccessRights(\ref{data:DataTypesPluggableDeviceID} pID, Map\textless{}int, \ref{data:DataTypesAccessRights}\textgreater{} accessRights)}
        \begin{itemize}[noitemsep,nolistsep]
...
\item Created for: UC9.7
  ...
  \subsection{AppDeviceData}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicAppDeviceData}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationFrontEndFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerContainerLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerManager}}, \iconcomponent{}~\vpett{\nameref{comp:ApplicationFrontEndClient}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationFrontEndFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC24.1
      ...
      \item \textsf{List\textless{}\ref{data:DataTypesRoomTopology}\textgreater{} getTopologyOverview(int applicationInstanceID, int customerOrganisationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns a list of RoomTopology containing devices that an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} has access to.
\item Created for: UC25.1
  ...
  \subsection{AppDeviceMgmt}\label{int:GatewayGatewayDeviceManagerAppDeviceMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayDeviceManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerManager}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{bool areEssentialDevicesOperational(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns true if all essential devices for a certain \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} are operational.
  ...
  \subsection{AppInstanceMgmt}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void activateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Activates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
\item Created for: UC17.3, U2 - easy applications
      ...
      \item \textsf{void createApplicationInstance(\ref{data:DataTypesApplicationInstance} instance, \ref{data:DataTypesApplicationCode} code)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Effect: Creates a new \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}} to run an instance of an application.
        \end{itemize}
      \item \textsf{void deactivateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Deactivates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
\item Created for: UC18, Av3: automatic suspension/reactivation of applications.
      ...
      \item \textsf{void destroyApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Destroys an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}
\item Created for: UC20.4ii
        \end{itemize}
      \item \textsf{boolean isApplicationInstanceAvailable(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns true if a certain \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} is available.
\item Created for: UC27.2
        \end{itemize}
      \item \textsf{void restartApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Restarts an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}
\item Created for: Av2
        \end{itemize}
...
\item Created for: UC22.12
      ...
      \item \textsf{void updateApplicationInstances(List\textless{}int\textgreater{} applicationInstanceIDs, \ref{data:DataTypesApplicationCode} code)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s to a new version.
\item Created for: UC22.15
  ...
  %%%%%%%% Applications
  \subsection{Applications}\label{int:OnlineServiceOnlineServiceApplicationProviderFacadeApplications}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationProviderFacade}}
...
\item Created for: UC22
  ...
  %%%%%%%% ApplicationTesting
  \subsection{ApplicationTesting}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicApplicationTesting}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void applicationTestsSuccessful(int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Lets the \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}} know the automatic application checks were successful.
\item Created for: UC22.13
        \end{itemize}
      \item \textsf{void applicationTestsUnsuccessful(int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Lets the \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}} know the automatic application checks were not successful.
\item Created for: UC22.13
        \end{itemize}
    \end{itemize}
    \end{description}
  ...
  \subsection{AppMessages}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppMessages}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerContainerLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerContainerLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void applicationInstanceFailed(int applicationInstanceID, int onOnlineService)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Lets the other parts of an application know that one of their parts has become unavailable. This allowd the other parts to possibly run in a degraded mode. Is called by an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainer}} after its \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} has crashed 3 times in a row.
\item Created for: Av1
      ...
      \item \textsf{void sendCommandToApplicationInstance(int applicationInstanceID, string command, boolean forOnlineService) throws \ref{ex:DataTypesAppMessageNotAllowedException}}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Sends a command to an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} that is running on the Online Service or on a \vpett{\nameref{comp:GatewayGateway}}.
\item Created for: UC26.1
      ...
      \item \textsf{void sendMessageToExternalFrontEnd(string hostName, int port, string message) throws \ref{ex:DataTypesAppMessageNotAllowedException}}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Sends a message from an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} to an external front end. The \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} provides the hostname and port.
\item Created for: UC26.1
        \end{itemize}
    \end{itemize}
    \end{description}
...
\item Created for: UC27.2
      ...
      \item \textsf{void updateApplicationActive(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s status to 'active'.
        \end{itemize}
      \item \textsf{void updateApplicationInstanceSuspended(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s status to 'suspended'.
        \end{itemize}
      \item \textsf{void updateApplicationStatusUnavailable(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Effect: Notifies the \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerMonitor}} that an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} has crashed.
\item Created for: Av2 - The system is able to autonomously detect failing applications
  ...
  %%%%%%%% Authentication
  \subsection{Authentication}\label{int:OtherDataDatabaseOtherDataDBAuthentication}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDatabaseOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceAuthenticationManager}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC28.2
  ...
  %%%%%%%% Authentication
  \subsection{Authentication}\label{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationProviderFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceAuthenticationManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceRegisteredUserFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationProviderFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceRegisteredUserFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC9.4
        \end{itemize}
      \item \textsf{void updateAccessRights(\ref{data:DataTypesPluggableDeviceID} id, Map\textless{}int, \ref{data:DataTypesAccessRights}\textgreater{} accessRights)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates the access rights on a certain pluggable device for a group of customer organisations.
\item Created for: UC9.7
        \end{itemize}
...
\item Created for: UC13.2
  ...
  \subsection{DBAppMgmt}\label{int:OtherDataDatabaseOtherDataDBDBAppMgmt}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void activateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Sets an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s status in the database to 'active'.
\item Created for: UC17.4, U2 - easy applications
        \end{itemize}
      \item \textsf{int createApplicationInstance(int custOrgID, int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Creates a new \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} for an application for a customer organisation and returns its id. The \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} gets status 'inactive', since it will be activated after a subscription is completed.
...
\item Created for: UC23.4
        \end{itemize}
      \item \textsf{\ref{data:DataTypesGatewayInfo} getApplicationInstanceGateway(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
...
\item Created for: UC23.2
      ...
      \item \textsf{List\textless{}\ref{data:DataTypesPluggableDeviceID}\textgreater{} getDevicesForApplication(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns a list of PluggableDeviceID of pluggable devices that an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} can use.
...
\item Created for: UC19.5, U2 - easy applications
      ...
      \item \textsf{void softDeleteApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s status in the database to reflect that the customer organisation has unsubscribed from it.
\item Created for: UC20.4ii
        \end{itemize}
...
\item Created for: UC22.14
      ...
      \item \textsf{void updateApplicationDevicesSettings(int applicationInstanceID, List\textless{}\ref{data:DataTypesPluggableDeviceID}\textgreater{} devices, List\textless{}\ref{data:DataTypesRelationship}\textgreater{} relationships)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s device settings. This includes which devices the instance can use and which relationships exist between those devices.
\item Created for: UC19.6, U2 - easy applications
        \end{itemize}
      \item \textsf{void updateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} in the database (e.g. change state to 'inactive').
\item Created for: UC18, Av3: automatic suspension/reactivation of applications.
        \end{itemize}
...
\item Created for: UC22.15
      ...
      \item \textsf{void updateCriticality(int applicationInstanceID, int isCritical)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates the criticality of an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
...
\item Created for: UC11, P2: storing new pluggable data
  ...
  \subsection{DBDeviceMgmt}\label{int:DeviceDatabaseDeviceDBDBDeviceMgmt}
    \begin{description}[noitemsep,nolistsep]
      ...
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayDeviceManager}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGateway}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationMonitor}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitor}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC21.1
      ...
      \item \textsf{void markActivatedApplication(int applicationInstanceID, int custOrgID, \ref{data:DataTypesDateTime} date)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s billing information: marks the start of a billing period.
\item Created for: UC17.4, U2 - easy applications
        \end{itemize}
    \end{itemize}
    \end{description}
  ...
  \subsection{DBSubscriptionMgmt}\label{int:OtherDataDatabaseOtherDataDBDBSubscriptionMgmt}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void createSubscription(int custOrgID, int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Creates a subscription for a customer organisation to an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}. If the customer organisation is already subscribed to an older version of the the application, then the organisation is unsubscribed from that earlier version.
...
\item Created for: UC10.5a
  ...
  %%%%%%%% DBUserMgmt
  \subsection{DBUserMgmt}\label{int:OtherDataDatabaseOtherDataDBDBUserMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OtherDataDatabaseOtherDataDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceUserManager}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{boolean areMandatoryUserRolesAssigned(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns true if all mandatory UserRoles for the application have been assigned to users. Finds the relevant customer organisations through the \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
...
\item Created for: UC19.8, U2 - easy applications
      ...
      \item \textsf{List\textless{}\ref{data:DataTypesUserRole}\textgreater{} getMandatoryUserRoles(int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns a list of UserRoles that which need to be assigned in order for an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} to run.
\item Created for: UC19.7, U2 - easy applications
      ...
      \item \textsf{List\textless{}\ref{data:DataTypesUserRole}\textgreater{} getOptionalUserRoles(int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns a list of UserRoles which can optionally be assigned for an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
\item Created for: UC19.7, U2 - easy applications
        \end{itemize}
      \item \textsf{List\textless{}\ref{data:DataTypesUser}\textgreater{} getUsersWithRoles(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Returns a list of Users associated to an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} that were assigned UserRoles.
\item Created for: UC17.6, U2 - easy applications
        \end{itemize}
...
\item Created for UC3.4
      ...
      \item \textsf{void updateUserRoles(int applicationInstanceID, Map\textless{}int, int\textgreater{} usersAndRoles)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates the UserRoles assigned to Users for a certain \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}. 'usersAndRoles' maps User IDs to UserRole IDs.
\item Created for: UC19.9, U2 - easy applications
  ...
  \subsection{DeliveryMgmt}\label{int:OnlineServiceOnlineServiceNotificationHandlerDeliveryMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceNotificationHandler}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:ThirdPartyNotificationDeliveryServiceNodeThirdPartyNotificationDeliveryService}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC15
  ...
  %%%%%%%% DeliveryMgmt
  \subsection{DeliveryMgmt}\label{int:OnlineServiceOnlineServiceInvoiceManagerDeliveryMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInvoiceManager}}
      \item[Required by:] None
      \item[Operations:] ~
...
\item Created for: UC11: system relays data to applications
  ...
  \subsection{FrontEndAppRequests}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationManagementLogicFrontEndAppRequests}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void activateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Checks and activates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} (UC17).
...
\item Created for: UC18, Av3: automatic suspension/reactivation of applications.
  ...
  %%%%%%%% GWCommunicationMonitoring
  \subsection{GWCommunicationMonitoring}\label{int:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationMonitoring}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGWCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationHandlerGatewayMonitor}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceGatewayCommunicationMonitor}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: The system is able to autonomously detect failures of its individual application execution components
      ...
      \item \textsf{void restart()}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Restarts the monitored component
\item Created for: Av2
        \end{itemize}
    \end{itemize}
    \end{description}
...
\item Created for: UC15
  ...
  %%%%%%%% Notifications
  \subsection{Notifications}\label{int:OnlineServiceOnlineServiceNotificationHandlerNotifications}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceNotificationHandler}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceRegisteredUserFacade}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{\ref{data:DataTypesNotification} getDetailedNotification(int userID, int notificationID)}
        \begin{itemize}[noitemsep,nolistsep]
...
\item Created for: UC16.2
  ...
  %%%%%%%% Notifications
  \subsection{Notifications}\label{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationProviderFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceRegisteredUserFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationProviderFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}}, \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}}
      \item[Operations:] ~
...
\item Created for: UC16.1
  ...
  %%%%%%%% Notifiy
  \subsection{Notifiy}\label{int:OnlineServiceOnlineServiceNotificationHandlerNotifiy}
    \begin{description}[noitemsep,nolistsep]
...
\item Created for: UC14, Av3: notifications
  ...
  %%%%%%%% OSCommunicationMonitoring
  \subsection{OSCommunicationMonitoring}\label{int:GatewayGatewayOnlineServiceCommunicationMonitorOSCommunicationMonitoring}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandler}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}}, \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationMonitor}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{\ref{data:DataTypesEcho} ping()}
        \begin{itemize}[noitemsep,nolistsep]
...
\item Created for: Av1 - If an internal SIoTIP gateway component fails, the gateway first tries to restart the affected component.
  ...
  %%%%%%%% OSMonitoring
  \subsection{OSMonitoring}\label{int:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogicOSMonitoring}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: Av1 - The SIoTIP gateway will start synchronising with the Online service within 1 minute after the communication channel becomes available.
  ...
  %%%%%%%% OSUpdates
  \subsection{OSUpdates}\label{int:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitorOSUpdates}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void onlineServiceUpdate()}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Lets the \vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOnlineServiceMonitor}} know that a message has been received from the Online Service
\item Created for: Av1 - The Online Service should acknowledge each message sent by the SIoTIP gateway so that the gateway can detect failures.
  ...
  %%%%%%%% Registration
  \subsection{Registration}\label{int:OnlineServiceOnlineServiceUnregisteredUserFacadeRegistration}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceUnregisteredUserFacade}}
      \item[Required by:] None
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{boolean canCustomerOrganisationRegister(int infrastructureOwnerID, string hash)}
...
\item Created for: UC24.2
  ...
  %%%%%%%% Requests
  \subsection{Requests}\label{int:GatewayGatewayOnlineServiceCommunicationHandlerRequestStoreRequests}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerRequestStore}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:GatewayGatewayOnlineServiceCommunicationHandlerOSCommunicationLogic}}
      \item[Operations:] ~
...
\item Created for: Av1 - The SIoTIP gateway will start synchronising with the Online service within 1 minute after the communication channel becomes available.
  ...
  %%%%%%%% RoleMgmt
  \subsection{RoleMgmt}\label{int:OnlineServiceOnlineServiceUserManagerRoleMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceUserManager}}
...
\item Created for: UC19.9, U2 - easy applications
  ...
  %%%%%%%% Sessions
  \subsection{Sessions}\label{int:SessionDBSessions}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:SessionDB}}
      \item[Required by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceAuthenticationManager}}
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
...
\item Created for: UC19.5, U2 - easy applications
      ...
      \item \textsf{void registerSubscriptionAndUpdateCriticality(int applicationInstanceID, boolean isCritical, int custOrgID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Registers a new subscription and updates the criticality of an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}.
\item Created for: UC19.11-12, U2 - easy applications
        \end{itemize}
      \item \textsf{int subscribeToApplication(int custOrgID, int applicationID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Creates a new \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} for an application for a customer organisation and returns its id.
\item Created for: UC19.4, U2 - easy applications
        \end{itemize}
...
\item Created for: UC20.4i
  ...
  %%%%%%%% TopologyMgmt
  \subsection{TopologyMgmt}\label{int:OnlineServiceOnlineServiceInfrastructureOwnerFacadeTopologyMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceInfrastructureOwnerFacade}}
      \item[Required by:] None
      \item[Operations:] ~
...
\item Created for: UC3.4
  ...
  %%%%%%%% UserMgmt
  \subsection{UserMgmt}\label{int:OnlineServiceOnlineServiceCustomerOrganisationFacadeUserMgmt}
    \begin{description}[noitemsep,nolistsep]
      \item[Provided by:] \iconcomponent{}~\vpett{\nameref{comp:OnlineServiceOnlineServiceCustomerOrganisationFacade}}
      \item[Required by:] None
      \item[Operations:] ~
...
\item \vpeexception{ex:DataTypesAddressInvalidException}{AddressInvalidException}
...
\item \vpeexception{ex:DataTypesEmailAddressAlreadyExistsException}{EmailAddressAlreadyExistsException}
Thrown if a new given email address already exists in the system.
\item \vpeexception{ex:DataTypesEmailAddressInvalidException}{EmailAddressInvalidException}
Thrown if a given email address is invalid. e.g. badly formatted
\item \vpeexception{ex:DataTypesEndUserAlreadyExistsException}{EndUserAlreadyExistsException}
Thrown if an entered end user already exists in the system.
\item \vpeexception{ex:DataTypesPaymentInformationInvalidException}{PaymentInformationInvalidException}
Thrown if given payment information is invalid.
\item \vpeexception{ex:DataTypesPhoneNumberInvalidException}{PhoneNumberInvalidException}
...
\item \vpeexception{ex:DataTypesUserNameAlreadyExistsException}{UserNameAlreadyExistsException}
...
\begin{itemize}[nolistsep,noitemsep]
\item \vpedatatype{data:DataTypesAccessRights}{AccessRights}:
\begin{itemize}[noitemsep,nolistsep]

\item[] Contains information about access rights to a pluggable device.
\end{itemize}
...
\end{itemize}
\item \vpedatatype{data:DataTypesApplicationCode}{ApplicationCode}:
\begin{itemize}[noitemsep,nolistsep]
...
\end{itemize}
\item \vpedatatype{data:DataTypesDeviceStatus}{DeviceStatus}:
\begin{itemize}[noitemsep,nolistsep]
...
\end{itemize}
\item \vpedatatype{data:DataTypesInvoice}{Invoice}:
\begin{itemize}[noitemsep,nolistsep]
...
\end{itemize}
\item \vpedatatype{data:DataTypesVersion}{Version}:
\begin{itemize}[noitemsep,nolistsep]
