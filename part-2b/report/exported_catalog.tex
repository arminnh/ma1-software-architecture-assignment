%%% element catalog, generated on Tue May 09 19:34:11 CEST 2017
  ...
  \subsection{AppInstanceMgmt}\label{int:OnlineServiceOnlineServiceApplicationManagerApplicationContainerAppInstanceMgmt}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void activateApplicationInstance(int applicationInstanceID)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Activates an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}} that is running on the gateway.
...
\item Created for: UC9.7
  ...
  \subsection{DBAppDeviceMgmt}\label{int:DeviceDatabaseDeviceDBDBAppDeviceMgmt}
    \begin{description}[noitemsep,nolistsep]
      ...
      \item[Operations:] ~
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{Map\textless{}{\colorbox{red!30}{\underline{DataTypesPluggableDeviceID}}}, string\textgreater{} getFormattingSyntaxForDevices(List\textless{}{\colorbox{red!30}{\underline{DataTypesPluggableDeviceID}}}\textgreater{} devices)}
        \begin{itemize}[noitemsep,nolistsep]
  ...
  \subsection{DBAppMgmt}\label{int:OtherDataDatabaseOtherDataDBDBAppMgmt}
    ...
    \begin{itemize}[noitemsep,nolistsep,leftmargin=-.25cm]
      \item \textsf{void activateApplication(int applicationInstanceID, string status)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Sets an \vpett{\nameref{comp:OnlineServiceOnlineServiceApplicationManagerApplicationContainerApplicationInstance}}'s status in the \vpett{\nameref{comp:OtherDataDatabaseOtherDataDB}} to 'active'.
