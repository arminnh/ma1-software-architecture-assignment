...
\subsection{Architectural design}
    ...
    \paragraph{U2: Gateway installation}
        ...
        gateway registers with online service:
            ...
            GatewayFacade -> DeviceDB: interface GWDeviceMgmt: registerGateway(GatewayID id, IPAddress address)
        ...
        UC19: Subscribe to application
            ...
            2. The system looks up the available applications (i.e., those to which the primary actor is not yet subscribed,
               or applications for which a newer version is available that requires a new subscription).
                    ...
                    % ApplicationManager -> Database:                    interface AppDataMgmt:      List<Application> getApplications()
            ...
            4. The primary actor selects the desired application.
                    ...
                    % ApplicationManager -> Database:                           interface AppDataMgmt:      int createNewApplicationInstance(int custOrgID, int applicationID) // returns an application instance id
            ...
            5. The system checks which topology configuration and selection of pluggable devices for the application are necessary
               ...
               and presents a topology allowing the primary actor to indicate their configuration.
                    ...
                    % ApplicationManager -> Database:                   interface AppDataMgmt:  List<RoomTopology> getNecessaryDevicesAndTopologyConfigurations(int applicationID) // load this data to display rules of the application in the UI
            ...
            6. The primary actor carries out the topology configuration.
                    ...
                    % ApplicationManager -> Database:                           interface AppDataMgmt:      void updateApplicationDevicesSettings(int applicationInstanceID, List<PluggableDeviceID> devices, List<Relationships> relationships)
            ...
            12. The system registers the subscription and criticality of the application.
                    ...
                    % ApplicationManager -> Database:                           interface AppDataMgmt:      updateCriticality(int applicationInstanceID, bool isCritical)
