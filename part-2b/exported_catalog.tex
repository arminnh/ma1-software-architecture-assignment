%%% element catalog, generated on Wed May 10 09:06:31 CEST 2017
...
\subsection{ApplicationProviderFacade}\label{comp:OnlineServiceOnlineServiceApplicationProviderFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for \vpett{\nameref{comp:\vpett{\nameref{comp:ApplicationProviderClient}}}} and handles all functionality that
can be done by application providers.
		\item[Super-components:]~None
		\item[Sub-components:]~None
...
\subsection{RegisteredUserFacade}\label{comp:OnlineServiceOnlineServiceRegisteredUserFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for common functionality between different types of users and handles
all functionality that is shared between them.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
...
\subsection{SystemAdministratorFacade}\label{comp:OnlineServiceOnlineServiceSystemAdministratorFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for SystemAdministratorClient and handles all functionality that
can be done by application providers.
		\item[Super-components:]~None
		\item[Sub-components:]~None
		\item[Provided interfaces:]~\iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceAuthenticationManagerAuthentication}}, \iconprovided{}~\vpett{\nameref{int:OnlineServiceOnlineServiceRegisteredUserFacadeNotifications}}
...
\subsection{UnregisteredUserFacade}\label{comp:OnlineServiceOnlineServiceUnregisteredUserFacade}
	\begin{description}[noitemsep,nolistsep]
		\item[Responsibility:]~Acts as an access point for \vpett{\nameref{comp:\vpett{\nameref{comp:UnregisteredUserClient}}}} and handles all functionality that
can be done by unregistered users.
		\item[Super-components:]~None
		\item[Sub-components:]~None
...
\item Created for: UC9.4
        \end{itemize}
      \item \textsf{void updateAccessRights(\ref{data:DataTypesPluggableDeviceID} pID, Map\textless{}int, {\colorbox{red!30}{\underline{DataTypes.AccessRights}}}\textgreater{} accessRights)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates the access rights on a certain pluggable device for a group of customer organisations.
...
\item Created for: UC9.4
        \end{itemize}
      \item \textsf{void updateAccessRights(\ref{data:DataTypesPluggableDeviceID} id, Map\textless{}int, {\colorbox{red!30}{\underline{DataTypes.AccessRights}}}\textgreater{} accessRights)}
        \begin{itemize}[noitemsep,nolistsep]
           \item Effect: Updates the access rights on a certain pluggable device for a group of customer organisations.
\item Created for: UC9.7
        \end{itemize}
